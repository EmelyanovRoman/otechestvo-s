...
function largeImageRecomendation() {

	var windowSize = $(window).width();
	if (windowSize >= 1024) {
		$('img[data-enlargable-recomendation]').addClass('data-enlargable-recomendation').click(function () {
			var src = $(this).attr('src');
			$('<div>').css({
...
// Larg image in licence

function largeImageLicence() {
	$("img[data-enlargable-licence]").click(function () {
		$(this).toggleClass("largeable");
	});
}
...
// Reviews Footer 
function reviewsLogoRight() {
	var logoSlide = $("#reviews_logo_right");
	if (logoSlide.length) {
		logoSlide.owlCarousel({
			loop: true,
			rtl: true,
...
// Reviews Footer 
function reviewsLogoLeft() {
	var logoSlide = $("#reviews_logo_left");
	if (logoSlide.length) {
		logoSlide.owlCarousel({
			loop: true,
			margin: -1,
